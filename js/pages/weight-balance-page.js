  ...
  function renderResult(elements, result) {
    const nodes = [
      ...
      ui.createGridCard("Geschwindigkeiten", "speed-grid", [
        createSpeedMetric(ui.el("span", {}, ui.speedSymbol("R"), " · Rotate"), result.speeds.rotateSpeedKmh),
        createSpeedMetric("in 15 m Höhe", result.speeds.speedAt15mKmh),
        createSpeedMetric(ui.el("span", {}, ui.speedSymbol("APP"), " · Approach"), result.speeds.approachSpeedKmh),
        createSpeedMetric(ui.el("span", {}, ui.speedSymbol("REF"), " · 1.3 × ", ui.speedSymbol("S0")), result.speeds.referenceSpeedKmh),
        createSpeedMetric(ui.el("span", {}, ui.speedSymbol("S0"), " · Leerlauf 40°"), result.speeds.stallIdleFlaps40Kmh),
      ]),
