  ...
  function renderResult(elements, inputs, result) {
    ui.replaceContent(elements.resultRoot, [
      ...
      ui.createGridCard("Ergebnis", "result-grid", [
        ui.createMetricItem({ label: "Landerollstrecke · Landing Roll", value: result.results.landingRollMeters, unit: "m" }),
        ui.createMetricItem({ label: "Landestrecke · Landing Distance", value: result.results.landingDistanceMeters, unit: "m" }),
      ]),
      ui.createGridCard("Anfluggeschwindigkeit VAPP", "speed-grid", [
        ui.createMetricItem({
          ...
          label: "VAPP IAS",
          value: core.kilometersPerHourToKnots(result.speeds.approachSpeedKmh).toFixed(1),
          unit: "kt",
          subtext: `${result.speeds.approachSpeedKmh.toFixed(0)} km/h`,
        }),
      ]),
